...
- Pagina opzioni, header (≤782px): a 651px i sei link del menu delle sezioni superavano di circa 30px lo spazio disponibile e «Backup» veniva tagliato senza alcun indizio; ora i link sono più compatti (entrano fino a circa 620px) e, quando il menu deve scorrere, il bordo con link nascosti sfuma (classi `has-more-start` / `has-more-end`).
