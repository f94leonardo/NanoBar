...
- `screenshot-1.png` — the floating toggle button on the frontend, with the quick-access menu open.
- `screenshot-2.png` — the Settings → NanoBar page, with the live position/size/color preview.
- `screenshot-3.png` — the automatic bottom tab bar on narrow (phone-width) screens.
...
cp .wordpress-org/*.png nanobar/assets/
cd nanobar
svn add assets/*.png
